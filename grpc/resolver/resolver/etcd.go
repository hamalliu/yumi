...
func Builder(c *clientv3.Config) internal.Builder {
	_once.Do(func() {
		_builder, _ = New(c)
	})
	return _builder
...
func (e *EtcdBuilder) Register(ctx context.Context, ins *internal.Instance) (cancelFunc context.CancelFunc, err error) {
	e.mutex.Lock()
...
//注册和续约公用一个操作
func (e *EtcdBuilder) register(ctx context.Context, ins *internal.Instance) (err error) {
...
func (e *EtcdBuilder) unregister(ins *internal.Instance) (err error) {
	prefix := e.keyPrefix(ins)
...
func (e *EtcdBuilder) keyPrefix(ins *internal.Instance) string {
