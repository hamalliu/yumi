...
func (c Config) New(cfg Editor) string {
	c.Type = cfg.Type
	c.Token = cfg.Token
	...
	c.Document.Info.SharingSettings = cfg.File.SharingSettings
	...
	c.EditorConfig.Customization.Goback = cfg.Goback
	c.EditorConfig.Customization.Customer = cfg.Customer
