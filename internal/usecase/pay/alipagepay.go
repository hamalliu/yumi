...
func (alipay AliPagePay) Pay(mch ali_pagepay.Merchant, order entity.OrderPay) ([]byte, error) {
	//订单是否过期
...
func (alipay AliPagePay) PayCompleted(mch ali_pagepay.Merchant, order entity.OrderPay) error {
...
func (alipay AliPagePay) PayProblem(mch ali_pagepay.Merchant, order entity.OrderPay) error {
	query := ali_pagepay.TradeQuery{
		TradeNo:    order.TransactionId,
		OutTradeNo: order.OutTradeNo,
	}
...
func (alipay AliPagePay) CheckStartPay(mch ali_pagepay.Merchant, order entity.OrderPay) error {
	query := ali_pagepay.TradeQuery{
		TradeNo:    order.TransactionId,
		OutTradeNo: order.OutTradeNo,
	}
...
func (alipay AliPagePay) CloseOrder(mch ali_pagepay.Merchant, order entity.OrderPay) error {
...
func (alipay AliPagePay) PayNotify(mch ali_pagepay.Merchant, rawQuery string) error {
