...
func CORS(allowOriginHosts []string) ymhttp.HandlerFunc {
	config := &CORSConfig{
...
func newCORS(config *CORSConfig) ymhttp.HandlerFunc {
...
func (cors *cors) applyCORS(c *ymhttp.Context) {
...
func (cors *cors) handlePreflight(c *ymhttp.Context) {
	header := c.Writer.Header()
...
func (cors *cors) handleNormal(c *ymhttp.Context) {
	header := c.Writer.Header()
